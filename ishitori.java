...
public class ishitori {
    public static void main(String[] args) {
        ...
        int allNum;
        while(true) {
            var stonenum = sc.nextLine();
            var allnum = Integer.parseInt(stonenum);
            if(10 <= allnum && allnum <= 100) {
                allNum = allnum;
                break;
            } else {
        ...
        var stoneSymbol = sc.nextLine();
        stoneSymbol = stoneSymbol.charAt();
